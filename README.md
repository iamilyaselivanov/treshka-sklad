...
- инициатор события не получает push о собственном действии; если администратор назначен на пост,
  сервер также не дублирует ему одинаковую выдачу постовым и управленческим уведомлением;
- выдача на пост — все активные сотрудники любой роли, назначенные на этот
  пост; если выдачу завершил кладовщик, владелец и все администраторы получают
  отдельное управленческое уведомление;
- новый акт дефектовки или выполненных работ — владелец, администраторы и
  кладовщики;
- выдача кладовщиком на пост — владелец и администраторы;
- возврат товара с поста — владелец, администраторы и кладовщики;
- согласованный АВР, ожидающий приёмки, — владелец, администраторы и кладовщики;
- приёмка кладовщиком изделия на склад после АВР — владелец, администраторы и
  кладовщики.
